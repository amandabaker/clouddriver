...
package com.netflix.spinnaker.clouddriver.azureContainers.health

/* 

    This was copied from the Azure module and doesn't make sense here. It simply exists 
    for reference so that the names of the methods are at least somewhat similar
